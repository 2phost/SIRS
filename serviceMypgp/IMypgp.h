...
#define NS_NO_VTABLE
#endif
class nsCrypto; /* forward declaration */
...
class NS_NO_VTABLE IMypgp : public nsISupports {
 public: 
  ...
  /* void keygen (); */
  NS_IMETHOD Keygen(void) = 0;

  /* string encrypt (in AString msg); */
  NS_IMETHOD Encrypt(const nsAString & msg, char * *_retval) = 0;

  /* string decrypt (in AString msg); */
  NS_IMETHOD Decrypt(const nsAString & msg, char * *_retval) = 0;
...
#define NS_DECL_IMYPGP \
  NS_IMETHOD Keygen(void); \
  NS_IMETHOD Encrypt(const nsAString & msg, char * *_retval); \
  NS_IMETHOD Decrypt(const nsAString & msg, char * *_retval); \
  NS_IMETHOD Add(int32_t a, int32_t b, int32_t *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_IMYPGP(_to) \
  NS_IMETHOD Keygen(void) { return _to Keygen(); } \
  NS_IMETHOD Encrypt(const nsAString & msg, char * *_retval) { return _to Encrypt(msg, _retval); } \
  NS_IMETHOD Decrypt(const nsAString & msg, char * *_retval) { return _to Decrypt(msg, _retval); } \
...
#define NS_FORWARD_SAFE_IMYPGP(_to) \
  NS_IMETHOD Keygen(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Keygen(); } \
  NS_IMETHOD Encrypt(const nsAString & msg, char * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Encrypt(msg, _retval); } \
  NS_IMETHOD Decrypt(const nsAString & msg, char * *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Decrypt(msg, _retval); } \
...
/* void keygen (); */
NS_IMETHODIMP _MYCLASS_::Keygen()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* string encrypt (in AString msg); */
NS_IMETHODIMP _MYCLASS_::Encrypt(const nsAString & msg, char * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* string decrypt (in AString msg); */
NS_IMETHODIMP _MYCLASS_::Decrypt(const nsAString & msg, char * *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
